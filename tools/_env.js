...
module.exports = function makeEnv(ctx, opts = {}) {
  ...
  global.document = { getElementById: () => cv, addEventListener: (n, f) => { listeners['doc:' + n] = f; }, hidden: false, querySelectorAll: () => opts.scriptTags || [] };
  ...
  global.__TEFT_CFG = Object.assign({ sdkWaitMs: 0, sdkInitMs: 50, adStubMs: 0, rewardedStubMs: 0, manualBoot: true }, opts.cfg || {});
  delete global.fetch; if (opts.fetch) global.fetch = opts.fetch;
