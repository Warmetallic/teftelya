...
const JUMPS_BASE = 4;
const UPGRADES = {
  jumps:  { levels: [{ price: 60, value: 5 }, { price: 300, value: 6 }] },                              // value — максимум зарядов
  magnet: { levels: [{ price: 80, value: 60 }, { price: 180, value: 90 }, { price: 400, value: 120 }] }, // value — радиус, px от края тефтели
};
